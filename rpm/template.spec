...
Name:           ros-noetic-pass-through-controllers
Version:        0.1.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS pass_through_controllers package
...
BuildRequires:  ros-noetic-cartesian-trajectory-controller
...
directly to a robot controller and let it handle trajectory interpolation and
execution.
...
%changelog
* Wed Jun 16 2021 Stefan Scherzinger <scherzin@fzi.de> - 0.1.0-1
